...
def write_attestat_image(degree,author,student,channel,sertificate_code):  
    # 1. Open the image
    # Make sure "input_image.jpg" is in the same directory or provide the full path
    if int(sertificate_code)==1:
        image = Image.open("certificates/1.png")
        import textwrap
        ...
        position_name = (700, 850)
        position_date = (740, 1600) 
        position_degree_ = (600, 960) 
        position_author = (1850, 1580) 
        ...
        try:
            font_name = ImageFont.truetype("/bot/arial.ttf", 85) # Specify font file and size
            font_date = ImageFont.truetype("/bot/arial.ttf", 50)
            font_author = ImageFont.truetype("/bot/arial.ttf", 65)
            font_degree_ = ImageFont.truetype("/bot/arial.ttf", 65)
        except IOError:
        ...
        return bio
        # return image.show()
    elif int(sertificate_code)==2:
        image = Image.open("certificates/2.png")
        import textwrap
        # 2. Create a drawing context
        draw = ImageDraw.Draw(image)
        # 3. Define the text and position
        ...
        # Coordinates (x, y) for the top-left corner of the text
        position_name = (700, 750)
        position_date = (740, 1600) 
        position_degree_ = (600, 860) 
        position_author = (1850, 1580) 
        # Color in RGB format (e.g., black is (0, 0, 0), white is (255, 255, 255))
        text_color = (0, 0, 0) 
        from datetime import date
    ...
    elif int(sertificate_code)==3:
        image = Image.open("certificates/3.png")
        import textwrap
        # 2. Create a drawing context
        draw = ImageDraw.Draw(image)
        # 3. Define the text and position
    ...
    elif int(sertificate_code)==4:
        image = Image.open("certificates/4.png")
        import textwrap
        # 2. Create a drawing context
        draw = ImageDraw.Draw(image)
        # 3. Define the text and position
        ...
        # Coordinates (x, y) for the top-left corner of the text
        position_name = (700, 910)
        position_date = (700, 1580) 
        position_degree_ = (600, 1050) 
        position_author = (1950, 1580) 
        # Color in RGB format (e.g., black is (0, 0, 0), white is (255, 255, 255))
        text_color = (0,0,0) 
        from datetime import date
        today = str(date.today())
        ...
        image = Image.open("certificates/5.png")
        import textwrap
        # 2. Create a drawing context
        draw = ImageDraw.Draw(image)
        # 3. Define the text and position
...
def write_simple_image(degree,author,student,sertificate_code):  
    # 1. Open the image
    # Make sure "input_image.jpg" is in the same directory or provide the full path
    if int(sertificate_code)==1:
        image = Image.open("certificates/1.png")
...
def write_school_image(degree,author,student,class_number,subject,sertificate_code):  
    # 1. Open the image
    # Make sure "input_image.jpg" is in the same directory or provide the full path
    if int(sertificate_code)==1:
        image = Image.open("certificates/1.png")
